...
# =====================================================
# Card-style CSS for equal visual blocks
# =====================================================
st.markdown(
    """
    <style>
...
# =====================================================
# Recreate clustering dataframe (self-contained)
# =====================================================
...
of individual countries and years.
"""
)
...
with row1_col1:
    ...
    st.markdown('<div class="card-title">Country–Year Clusters</div>', unsafe_allow_html=True)
...
with row1_col2:
    st.markdown('<div class="card">', unsafe_allow_html=True)
    st.markdown('<div class="card-title">Cluster Sizes</div>', unsafe_allow_html=True)
...
with row2_col1:
    st.markdown('<div class="card">', unsafe_allow_html=True)
    st.markdown('<div class="card-title">Terrorist Incidents Over Time</div>', unsafe_allow_html=True)
...
with row2_col2:
    st.markdown('<div class="card">', unsafe_allow_html=True)
    st.markdown('<div class="card-title">Distribution of Terrorist Incidents</div>', unsafe_allow_html=True)
